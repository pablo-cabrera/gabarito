(function (node) {
    ...
    var formatMessage = function (msg, args) {
        ...
        return msg.replace(/[$%](\d+|s)/g, function (m) {
            ...
            return m.charAt(0) === "$"? parts.dump(arg): String(arg);
        });
    };
    ...
    var assert = {
         ...
         * @param {string} [msg] The error message
         */
        hasProperty: test("Object should have the property", hasProperty),
    ...
    var AssertThat = ilk.tokens(function (value) {
        ...
        proto({
            ...
            hasSizeOf: parts.overload(
                ...
                function (size, msg) {
                    assert.areSame(size, this[value].length, msg);
                })
        });
        ...
        parts.forEach(assert, function (v, p) {
            if (p !== "that") {
                ...
                AssertThat.proto(
                    ...
                    p,
                    p === "areSame" || p === "areEqual"?
                    parts.args(function (args) {
                        return assert[p].apply(null,
                                [args[0], this[value]].concat(args.slice(2)));
                    }):
                    parts.args(function (args) {
    ...
    var Matcher = ilk.tokens(function (msg) {
        ...
        proto({
            ...
            error: function (value, position) {
                return new Error(
                    arguments.length > 1?
                    formatMessage(this[msg], [value, ordinal(position)]):
                    formatMessage(this[msg], [value]));
            }
        });
    });
    ...
    parts.merge(matcher, {
         ...
         * stores the value passed to the matcher for further inspection
         * later on.
         *
         * It works as a varargs matcher.
         *
         * @method mather.argsGrabber
         * @for gabarito.Gabarito
         *
         * @return {gabarito.VarargsMatcher}
         */
