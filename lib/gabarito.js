(function (node) {
    ...
    /**
     * The matcher consists of a single function that evaluates whether a given
     * values meets the matcher function criteria.
     *
     ...
     */
    var Matcher = ilk(function (matcher) {
        if (!(this instanceof Matcher)) {
            return new Matcher(matcher);
        }

        /**
         * The mather method should evaluate the matcher function and tell
         * whether the value matches the criteria.
         *
         * @method matches
    ...
    var VarargsMatcher = Matcher.descend();
    ...
    parts.merge(matcher, {
         ...
         */
        args: function (fn) { return new VarargsMatcher(fn); },
    ...
    var Spy = ilk.tokens(function (
        ...
        proto({
            args: parts.args(parts.that(function (that, args) {
                ...
                if (!(lastArg instanceof VarargsMatcher) &&
                    ...
                    throw new Error("Args number mismatch: " +
                            this[call].args.length + " args passed.");
                }
        ...
        return ilk(parts.that(function (that, fn) {
            ...
            this.handler = parts.args(function (args) {
                ...
                try {
                    call.returning = fn.apply(this, args);
