(function (node) {
    ...
    var Gabarito = parts.tokens(function (
        ...
        return parts.type(parts.that(function (t) {
            ...
            privateProperties.forEach(function (p) { p.mark(t); });
        ...
        proto(runBlock, parts.that(function (that, block, done) {
            ...
            if (!this[waiting]) {
                ...
                this[onResume] = function (block) { that[runBlock](block, done); };
            }
        })).
        ...
        proto(verifyClause, parts.that(function (that, test, clause, done) {
            ...
            this[runBlock](test[clause], function (error) {
        ...
        proto(nextTest, parts.that(function (that, done) {
            var test = this[tests].shift();
            if (test) {
                this[verifyTest](test, function () { that[nextTest](done); });
            } else {
                done();
            }
        })).
    ...
    if (node) {
        ...
        gabarito.runner = {
            ...
            JUnitXmlReporter: require("./runner/JUnitXmlReporter"),
